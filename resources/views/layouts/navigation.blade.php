            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-nav-link :href="route('admin.food.index')" :active="request()->routeIs('admin.food.index')">
                            {{ __('Меню') }}
                        </x-nav-link>
                        ...
                        <x-nav-link :href="route('settings.show', 1)" :active="request()->routeIs('settings.show', 1)">
                            {{ __('Настройки сайта') }}
                        </x-nav-link>
                    </div>
                </div>
